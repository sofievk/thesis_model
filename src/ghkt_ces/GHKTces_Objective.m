...
function f = GHKTces_Objective(x,A,A2t,A3t,At,Delta,en_K,ex,K0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_en,gZd_y,gZBGP,gamma,kappa_capacity,kappa_supply,kappa1,kappa2,kappa3,phi,phi0,phiL,rho,rho_energy,sigma,v,ypsilon)
