...
f = nestedcd_Objective(x0,B,A2t,A3t,Delta,Delta_G,en_K,ex,G0,eta_GDP,K0,M0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_coal,gZ_green,gZd_y,gZBGP,gamma,kappaL,kappaM,kappa1,kappa2,kappa3,kappa_capacity, kappa_supply,phi,phi0,phiL,phi_m,psi,rho,rho_E3,rho_energy,sigma,ypsilon);
[c, ceq] = nestedcd_Constraints(x0,B,A2t,A3t,Delta_G,Delta,en_K,ex,G0,eta_GDP,K0,M0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_coal,gZ_green,gZd_y,gZBGP,gamma,kappaL,kappaM,kappa1,kappa2,kappa3,kappa_capacity, kappa_supply,phi,phi0,phiL,phi_m,psi,rho,rho_E3,rho_energy,sigma,ypsilon);
...
[x, fval,exitflag] = fmincon(@(x)nestedcd_Objective(x,B,A2t,A3t,Delta,Delta_G,en_K,ex,G0,eta_GDP,K0,M0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_coal,gZ_green,gZd_y,gZBGP,gamma,kappaL,kappaM,kappa1,kappa2,kappa3,kappa_capacity, kappa_supply,phi,phi0,phiL,phi_m,psi,rho,rho_E3,rho_energy,sigma,ypsilon), x0, [], [], [], [], lb, ub, @(x)nestedcd_Constraints(x,B,A2t,A3t,Delta,Delta_G,en_K,ex,G0,eta_GDP,K0,M0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_coal,gZ_green,gZd_y,gZBGP,gamma,kappaL,kappaM,kappa1,kappa2,kappa3,kappa_capacity, kappa_supply,phi,phi0,phiL,phi_m,psi,rho,rho_E3,rho_energy,sigma,ypsilon), options);
