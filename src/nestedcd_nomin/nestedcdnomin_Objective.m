...
function f = nestedcdnomin_Objective(x,A2t,A3t,Delta,Delta_G,in_GDP,en_K,eff_E,G0,K0,M0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_coal,gZ_green,gZd_y,gKd_y,gZBGP,gamma,kappaL,kappaM,kappa1,kappa2,kappa3,phi,phi0,phiL,phi_m,psi,rho,rho_E3,sigma,ypsilon) 
