function [c, ceq] = NEWPF_Constraints(x,A2t,A3t,Delta,eff_K,eff_L,K0,N,R0,S1_2000,S2_2000,Sbar,T,alpha,beta,gZ_en,gZd_y,gZBGP,kappa1,kappa2,kappa3,phi,phi0,phiL,rho,sigma,ypsilon)
