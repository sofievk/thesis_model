...
vars = 3*T+2*(T-1);         %Number of variables = 148
...
for i = 1:1:3*T;
    ub(2*(T-1)+i) = 1;        %For coal and wind labor shares + energy share capital 
    lb(2*(T-1)+i) = 0.00001;  %For coal and wind labor shares + energy share capital
end
